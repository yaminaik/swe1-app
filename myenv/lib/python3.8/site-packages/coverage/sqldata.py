...
class CoverageData(SimpleReprMixin):
    ...
    * **file tracer names**: the module names of the file tracer plugins that
    ...
    def __init__(
        self, basename=None, suffix=None, no_disk=False, warn=None, debug=None
    ):
    ...
    def update(self, other_data, aliases=None):
        ...
        with other_data._connect() as con:
            ...
            lines = {
                (files[path], context): numbits for (path, context, numbits) in cur
            }
            cur.close()
        ...
        with self._connect() as con:
            ...
            file_ids = {
                path: id for id, path in con.execute("select id, path from file")
            }
    ...
    def measured_contexts(self):
        ...
        with self._connect() as con:
            contexts = {
                row[0] for row in con.execute("select distinct(context) from context")
            }
        return contexts
