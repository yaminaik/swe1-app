...
class DebugOutputFile:  # pragma: debugging
    ...
    def get_one(cls, fileobj=None, show_process=True, filters=(), interim=False):
        ...
        the_one, is_interim = getattr(
            singleton_module, cls.SINGLETON_ATTR, (None, True)
        )
        if the_one is None or is_interim:
            if fileobj is None:
                debug_file_name = os.environ.get(
                    "COVERAGE_DEBUG_FILE", FORCED_DEBUG_FILE
                )
...
def show_calls(
    show_args=True, show_stack=False, show_return=False
):  # pragma: debugging
